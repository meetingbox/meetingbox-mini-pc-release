...
# TITLE_LABEL is widened so autogenerated meeting names (for example
# "Meeting 20260527_0603...") can render without truncating before the
# duration. The separator dot + duration sit after the widened title area.
CHECK_BADGE = canvas_box(100.291, 153.968, 46.614, 46.614)
HEADLINE_LABEL = canvas_box(159.617, 152.555, 360.0, 44.0)
TITLE_LABEL = canvas_box(159.617, 199.170, 560.0, 34.0)
DOT_SEPARATOR = canvas_box(728.900, 216.120, 5.65, 5.65)
DURATION_LABEL = canvas_box(750.088, 199.170, 140.0, 34.0)
