"""
Floating visual indicator for the local Pepper voice assistant.
"""
...
class VoiceAssistantIndicator(BoxLayout):
    ...
    def set_state(self, state: str, message: str | None = None):
        ...
        if state == "idle":
            ...
            self.subtitle_label.text = message or 'Say "Hey Nexa"'
            ...
            self.subtitle_label.text = message or 'Heard "Hey Nexa"'
